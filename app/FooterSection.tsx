        ...
        <div className="footerBottom">
          <div className="footerLogoContainer">
            <div className="footerLogoIcon">
              <img src="/logo-v2.png?v=6" alt="The Viral Duo Logo" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
            </div>
            <img src="/logo-text.png?v=2" alt="The Viral Duo" className="footerLogoImg" />
          </div>
