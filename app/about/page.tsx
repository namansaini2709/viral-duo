        ...
        <div className="visionContent">
          ...
          >
            <span className="pill pink" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
              <img src="/logo-v2.png" alt="The Viral Duo Small Logo" style={{ width: '18px', height: '18px', objectFit: 'contain', borderRadius: '50%' }} />
              OUR VISION
            </span>
              ...
              >
                ...
                <div className="memberInfo">
                  <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <img src="/logo-v2.png" alt="The Viral Duo Small Logo" style={{ width: '20px', height: '20px', objectFit: 'contain', borderRadius: '50%' }} />
                    {teamData[i].name}
                  </h3>
                  <p>{teamData[i].role}</p>
                </div>
